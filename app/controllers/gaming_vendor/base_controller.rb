class GamingVendor::BaseController < ApplicationController
  layout 'admin'
  ...
  private
    def authorize_section!
      if !current_vendor.is_a?(GamingVendor)# || !current_vendor.is_a?(Admin)
    ...
    def set_default_environment!
      ...
      @test_environment = (session[:crud_environment].to_sym == :test)
    end
